...
public class BetterMainActivityTest {
    ...
    public void test_one_plus_one_equals_two() {
        ...
        scenario.onActivity(activity -> {
            ...
            Button btnEqual = (Button) activity.findViewById(R.id.btn_equals);
            btn1.performClick();
            btnPlus.performClick();
            btn1.performClick();
            btnEqual.performClick();
            TextView sum = (TextView) activity.findViewById(R.id.display);
            String sumStr = (String) sum.getText();
            assertEquals("2", sumStr);
        });
    }
}
